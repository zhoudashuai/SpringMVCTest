...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>证件照：</strong><img alt="没有" src="${pageContext.request.contextPath }${user.idPicPath}" style="width:450px;height:200px"/></p>
            <p><strong>工作证照：</strong><img alt="没有" src="${pageContext.request.contextPath }${user.workPicPath}" style="width:450px;height:200px"/></p>
